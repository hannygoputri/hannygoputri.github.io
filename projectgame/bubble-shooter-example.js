...
window.onload = function() {
    ...
    function main(tframe) {
        ...
        if (!initialized) {
            ...
            context.font = "16px Second Chances Solid";
    ...
    function render() {
        ...
        context.font = "18px KG Second Chances Solid";
        ...
        context.font = "24px KG Second Chances Solid";
        ...
        if (gamestate == gamestates.gameover) {
            ...
            context.fillStyle = "#ffffff";
            context.font = "24px Second Chances Solid";
    ...
    function drawFrame() {
        ...
        // Draw title
        context.fillStyle = "#FAC1E1";
        context.font = "24px KG Second Chances Solid";
        context.fillText("Bubble Shooter Game", 10, 37);
        
        // Display fps
        context.fillStyle = "#ffffff";
        context.font = "12px KG Second Chances Solid";
    ...
    function drawBubble(x, y, index) {
        ...
        context.drawImage(bubbleimage, index * 40, 0, 37.5, 40, x, y, level.tilewidth, level.tileheight);
    }
